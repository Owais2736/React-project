    ...
    <>
      ...
      <section className='main'>
        <div className="left w-full mt-6 flex gap-[270px] ">
          ...
          <div className={`flex p-7 gap-4 flex-wrap w-full md:w-[76%] rounded-xl mt-7 ml-[-340px]  md:ml-[-250px] bg-gray-100  `}>
            <div className='w-[70%]'>
              <form onSubmit={handleSubmit(onSubmit)} action=''>
                ...
                <br />
                <input className='w-[140px] ml-[210px] md:ml-[60vw] h-8 mt-2 bg-blue-700 text-[white] font-semibold text-[14px] cursor-pointer rounded-xl' disabled={isSubmitting} type="submit" value="ADD" />
