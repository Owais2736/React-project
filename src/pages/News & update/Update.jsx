    ...
    <>
     <section className='top'>
        <div className='flex justify-between items-center text-center mt-8 md:mt-3'>
          <div className={`font-bold text-[14px] ml-4 md:ml-[21vw]   ${!toogle ? "" : "hidden"}`}>News And Updates</div>
          <div className={` mt-4`}>
            <div className={`font-bold text-[14px] ${!toogle ? "hidden" : ""} ml-4 md:w-[160px] w-[100px] md:ml-[19vw]  `}>Create News</div>
          </div>
