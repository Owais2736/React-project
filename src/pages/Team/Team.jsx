    ...
    <>
      <section className='top'>
        <div className='flex justify-between items-center text-center mt-8 md:mt-3'>
          ...
          <div className={` mt-4`}>
            <div className={`font-bold text-[14px] ${!toogle ? "hidden" : ""} ml-4 md:w-[100px] w-[100px] md:ml-[21vw]  `}>Create Team</div>
          </div>
      ...
      <section className='main'>
        <div className="w-full mt-[-10px] flex gap-[270px] ">
          <LeftNav />
          <div className={`flex flex-col md:flex-row p-4 gap-4 flex-wrap w-full md:w-[78%] rounded-xl mt-4 ml-[-350px]  md:ml-[-250px] bg-gray-100  ${!toogle ? "" : "hidden"} `}>
            {team.map(data => {
              return (
                <div key={data.name} className='card w-[full] md:w-[24vw] h-[400px] rounded-xl  bg-white'>
                  ...
                  <div className='flex flex-col pl-4 gap-3'>
                    <div className='flex gap-5 pt-9  items-center mt-[-30px] '>
                      ...
                      <div onClick={showModal} className=' w-[27px] mt-[-10px] ml-auto  rounded-md bg-gray-400 cursor-pointer '>
                    ...
                    <div>
                      <Button1 title={"100+ Cases"} borderColor={"border-orange-400"} border={"border-2"} round={"rounded-md"} width={"w-[160px]"} height={"h-14"} svg={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="35px" height="35px" color="brown" fill="none">
          ...
          <div className={`mt-3 md:ml-0  ml-[-300px] ${!toogle ? "hidden" : ""}`}>
            <LawyerForm />
           </div>
        </div>
      </section>
