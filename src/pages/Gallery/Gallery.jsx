    ...
    <>
      <section className='main'>
        <div className="w-full mt-7 md:mt-2 flex gap-[240px] ">
          <LeftNav />
          <div className={`flex flex-col gap-7  h-72 p-7 w-full md:w-[78%] rounded-xl mt-[-10px] ml-[-308px] md:ml-[-230px] bg-gray-100  `}>
            <div>
              <GallaryForm1 />
            </div>
            ...
            <div className='rounded-xl mt-[-15px] w-screen md:w-[78vw] ml-[-27px] pt-3 p-7 bg-gray-100 '>
              <GalleryForm3 />
            </div>
            <div className='mt-[-14px] ml-[200px] md:ml-[65vw]'>
