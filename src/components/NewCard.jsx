        ...
        <>
            {
                news.map(data => {
                    return (
                        ...
                        <div key={data.name} className=' w-[355px] sm:w-[492px] bg-white rounded-xl'>
                            <div onClick={showModal} className='cursor-pointer ml-[460px] w-[25px] mt-[-20px] h-6 rounded-lg bg-gray-300 '>
