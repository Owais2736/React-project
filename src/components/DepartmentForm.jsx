...
function CreateForm() {
    ...
    return (
        <>
            <div className="md:w-[77vw] w-[90vw]  rounded-xl bg-gray-300">
                <div className=" md:w-[77vw] w-[90vw]  p-5">
                    <div className="bg-white rounded-xl p-10">
                        ...
                        <div>
                            <input className="text-[12px] pl-5 h-9 mt-5 border-2 rounded-2xl w-[68vw]" type="text" placeholder="Enter Department Title" />
                        </div>
                        <div>
                            ...
                            <div className="mt-5">
                                <Button1 title={"Add Lowyers"} text={"text-[12px]"} border={"border-2"} round={"rounded-3xl"} svg={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="26" height="26" fill="none">
                                ...
                                </svg>} color={"text-blue-800"} height={"h-12"} width={"w-[150px]"} />
                            </div>
                            <div className="mt-5">
                                <Button1 title={"ADD"} background={"bg-blue-800"} text={"text-[14px]"} border={"border-2"} round={"rounded-3xl"} color={"text-white"} height={"h-12"} width={"w-[100px]"} />
                            </div>
